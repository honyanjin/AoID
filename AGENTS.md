...
- **판정 기준**: 브라우저의 CSS 뷰포트 너비를 기준으로 다음 5개 뷰를 사용한다. 경계값은 중복이나 누락 없이 정확히 적용한다.
  - **모바일뷰**: `width < 768px`
  - **FHD뷰**: `768px <= width < 1920px`
...
- 각 구간의 최소·최대 너비와 정확한 경계값(`767px`, `768px`, `1919px`, `1920px`, `2559px`, `2560px`, `3839px`, `3840px`)에서 요소 겹침, 잘림, 의도하지 않은 가로 스크롤, 과도한 빈 공간이 없는지 검증한다.
